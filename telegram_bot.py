...
def cevap_uret(client_gemini, soru, baglam, gecmis, gorsel_b64=None, gorsel_mime=None,
    ...
    sistem_mesaji = (
        ...
        "birikimin gibidir, dışarıdan kaynak gibi sunma — ama bu, onları "
        "yok sayıp genel bilgine dönmen demek DEĞİL. Notlardaki somut "
        "bilgiyi (isimli teknik/drill adları, spesifik sayılar, o kaynağa "
        "özgü yaklaşımlar) DÜŞÜNCE SÜRECİNE dahil et — ama bunu ASLA "
        "'video şöyle diyor' diye alıntılama/kaynak gösterme, ve cümleleri "
        "olduğu gibi kopyalama. Bunun yerine: o bilgiyi bir VERİ/GERÇEK "
        "olarak al, kendi mantığınla harmanla, ve sonucu kendi analizin/"
        "tavsiyen gibi sun — 'bu teknik şunu hedefliyor, senin durumunda "
        "da şu şekilde işe yarar' tarzı bir akıl yürütme. Yani alıntı "
        "yapmıyorsun ama bilgiyi de görmezden gelmiyorsun — onu "
        "SENTEZLEYİP kendi tavsiyene dönüştürüyorsun. Notlar zayıf/"
        "yüzeyselse bunu fark et, kendi uzmanlığınla derinleştir. "
        "Alakasız notları SESSİZCE ele, açıklamaya gerek yok.\n\n"
