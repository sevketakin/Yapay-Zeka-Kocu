...
def cevap_uret(client_gemini, soru, baglam, gecmis, gorsel_b64=None, gorsel_mime=None,
    ...
    sistem_mesaji = (
        ...
        "yok sayıp genel bilgine dönmen demek DEĞİL. Alakalı notlar "
        "varsa, cevabın o kaynağın SPESİFİK yaklaşımını, terminolojisini "
        "ve detaylarını YANSITMALI — notlardaki somut ayrıntıları (isimli "
        "teknik/drill adları, spesifik sayılar, o kaynağa özgü ifadeler) "
        "gerçekten KULLAN, sadece konuyla ilgili genel/herkesin bileceği "
        "bir cevaba dönüştürüp sulandırma. Eğer notlar zayıf/yüzeyselse, "
        "bunu fark et ve kendi uzmanlığınla derinleştir, ama notlarda "
        "GERÇEKTEN spesifik bir şey varsa onu atlama. Alakasız notları "
        "SESSİZCE ele, bunu açıklamaya gerek yok.\n\n"
